...
<sup>Please note that executing the `batches\hide.bat` command, those required programs installed at the beginning have been actually hidden from the computer archive and won't be listed when searching through the Start Menu. <br />
