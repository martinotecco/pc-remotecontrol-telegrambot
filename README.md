...
**2.** open "python-3.11.1-amd64.exe" to install Python 3.11.1, the first required program, make sure to select the option to add it to the PATH <br />
**3.** open "VC_redist.x64.exe" to install Microsoft Visual C++ 14, the second required program <br />
**4.** open "vs_BuildTools.exe" to install Microsoft Visual Studio Build Tools 2022, the third required program, you'll have to choose 'Desktop development with C++' after <br />
...
<sup>please note that those required programs installed at the beginning are actually hidden from the computer archive and won't be listed when searching through the Start Menu</sup>
