...
## How to install
<sup>first of all, be sure to navigate as a Guest or in Incognito mode, so close this page if you're navigating in the default mode and delete the browser history
