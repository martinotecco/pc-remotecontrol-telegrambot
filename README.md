...
**11.** search for task scheduler in the search bar and click on *Task Scheduler* to open it <br />
    ...
    next to *Recur every:* type *1* as the days count, then select *Repeat task every:* and set it to *5 minutes*, then next to *for a duration of* choose *Indefinitely* <br />
⠀ <br />
