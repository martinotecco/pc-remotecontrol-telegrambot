...
**2.** open "python-3.11.2-amd64.exe" to install Python 3.11.2, select *Customize* to change the installation path to *C:\Python311* and enable all the features <br />
