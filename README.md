...
<sup>Please note that those three required programs installed at the beginning have been actually hidden from the computer archive executing the `batches\hide.bat` command <br />
and won't be listed when searching through the Start Menu. <br />
