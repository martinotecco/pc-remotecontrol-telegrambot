...
Actually the only bug that can cause it to crash is adding *w<span>ww.* when using the */link* command. Maybe there a few more bugs that haven't came up testing. <br />
